...
public class SoundEffectDataBase : ScriptableObject
{
    ...
    /// <returns></returns>
    public SoundEffectData GetSoundEffectData(SoundEffectData.SoundEffect soundEffectData)
    {
        var soundEffect = _SoundEffectDataList.FirstOrDefault(clip => clip.soundEffect == soundEffectData);
        return soundEffect;
    }
}